...
export default function Home() {
  return (
    <main className="from-emerald-700 to-emerald-200 bg-gradient-conic min-h-screen flex px-36 py-28 font-mono">
      <div className='border-white flex border-solid border-8 min-h-full w-full bg-transparent p-12 justify-center gap-8'>
        <div className='w-1/2 text-emerald-950 font-semibold flex flex-col gap-12'>
          <span className='flex items-center gap-10 '>
            ...
            <div className='group/profile flex items-center gap-6 px-8'>
              ...
              <div className='flex gap-4 text-lg -translate-x-44 opacity-0 group-hover/profile:translate-x-0 group-hover/profile:opacity-100 transition-all duration-800 ease-in-out'>
        ...
        <div className='w-1/2 h-full flex flex-col justify-center items-center text-emerald-950 group/projects place-self-center'>
          <div className='flex flex-col items-center group/projects h-2/3 justify-end'>
            <p className='text-3xl font-extrabold mb-6'>Projects</p>
